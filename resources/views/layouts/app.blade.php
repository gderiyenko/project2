...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Preview page of Metronic Admin Theme #4 for custom bootstrap overlay elements to be used on any container" name="description" />
        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <! Branding Image 
                    <a class="navbar-brand cyan" href="{{ url('/') }}">
                        AntiShop
                    </a>
                </div>
